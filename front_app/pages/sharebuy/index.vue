<template>
    <div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="top-banner-wrapper">
                                            <img src="/images/banners/sharebuy.jpg" class="img-fluid" />
                                            <div class="top-banner-content small-section" v-bind:class="{'px-3': $device.isMobile,'px-5': !$device.isMobile,}">
                                                <!--                        <h3 class="theme-color font-weight-bold text-center">{{ $t("services.share_sales.title") }}</h3>-->
                                                <p style="line-height: 1.5rem !important;">
                                                    {{ $t( "services.share_sales.title" ) }}は、PinGoで見つけたお気に入りの商品をSNSへ投稿するだけで、 あなたの紹介からその商品を購入した人のポイントがあなたにも戻ってくる仕組みです。
                                        ...
                                        <div class="collection-product-wrapper">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="product-filter-content">
                                                            <div class="search-count">
                                                                <h5 v-if="productslistMeta.total">
                                                                    {{ productslistMeta.total }} 点の商品が販売中!
                                                                </h5>
                                                            </div>
                                                ...
                                                <div class="col">
                                                    <div class="dataTables_paginate paging_simple_numbers float-right">
                                                        <ul class="pagination pagination-rounded">
                                                            <b-pagination v-model="page" pills aria-controls="pingoproduct_table" :total-rows="
                                                                    productslistMeta.total" :per-page="page_size" @change="tablePageChange">
                                                            </b-pagination>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="product-wrapper-grid" :class="{'list-view':listview == true,}">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="text-center section-t-space section-b-space" v-if="productslistMeta.total ===0">
                                                            <img v-lazy="'/images/empty-search.jpg'" class="img-fluid" alt />
                                                            <h3 class="mt-3">
                                                                Sorry! Couldn't find the product you were looking For!!!
                                                            </h3>
                                                            <div class="col-12 mt-3">
                                                                <nuxt-link :to="{path: '/',}" class="btn btn-solid">continue shopping
                                                                </nuxt-link>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-grid-box" :class="{'col-lg-3 col-md-4 col-sm-6':col4 == true,
                                                                'col-lg-4 col-sm-6':col3 == true,
                                                                'col-sm-6':col2 == true,
                                                                'col-lg-2 col-md-4 col-sm-6':col6 == true,
                                                                'col-lg-12':listview ==true,}" v-for="(product, index) in productslist" :key="index">
                                                        <div class="product-box">
                                                            <productBox @showQuickview="showQuickview" @ShowShareQR="ShowShareQR" :product="product" :index="index" :isListview="listview" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row my-2" v-if="productslistMeta.total">
                                                <div class="col">
                                                    <div class="dataTables_paginate paging_simple_numbers float-right">
                                                        <ul class="pagination pagination-rounded">
                                                            <b-pagination v-model="page" pills aria-controls="pingoproduct_table" :total-rows="productslistMeta.total" :per-page="page_size" @change="tablePageChange">
                                                            </b-pagination>
                                                        </ul>
                                                    </div>
                                                </div>
        ...
        <shareproductModel :openModal="shareproductModal" @closeModal="closeShareQRModel" />
    </div>
</template>
...
export default {
    ...
    components: {
        ...
        shareproductModel: () =>
            import ("./components/shareproduct"),
        TopLinks: () =>
            import ("~/components/widgets/TopLinks"),
    },
    data() {
        return {
