...
<!--              <div>-->
<!--                <a href="javascript:void(0);" @click="selectCategory(0)" class="text-muted">-->
<!--                      {{$t('menu.all')}}</a>-->
<!--              </div>-->
              <div v-for="category in categories">
                <ul v-if="category.pingo_product_count">
                  <li v-for="subcategory in category.children"
                      class="d-block d-flex justify-content-between line-height-2">
                    <a href="javascript:void(0);" @click="selectCategory(subcategory.id)" class="text-muted"
          ...
          <!--            <a href="javascript:void(0);" class="text-muted" @click="LoadExpiredProducts">募集終了商品</a>-->
          <!--          </h3>-->
        </div>
      </div>
