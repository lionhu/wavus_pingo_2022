...
const urls = {
  ...
  update_batch: "/admin_back/api/orders/update_batch/",
  ...
  superadmin_ordercompleted_batch:
    "/admin_back/api/orders/set_status_completed_batch/",
...
function updateOrderItemStatus_vendor({
