          ...
          <div class="row form">
            ...
            <div class="col-6 border-left">
              ...
              <div class="form-group mb-3">
                ...
                <div class="col-md-12">
                  <b-form-input for="text" v-model="info.delivery_info.track_no" @keyup="deliverinfo_changed"></b-form-input>
                </div>
              </div>
              <div class="form-group mb-3">
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="text-center mt-md-3">
                <b-spinner class="m-2" letiant="danger" role="status" v-if="updating"></b-spinner>
                <div class="mb-3">
                  <b-button letiant="danger" class="btn-rounded ml-1" @click="update_orderitem">
                    Update
                  </b-button>
                </div>
              </div>
  ...
  watch: {
    openDeliveryModal: function (newvalue, oldvalue) {
      if (newvalue && this.orderitem !== null) {
        ...
        let _day = new Date(this.orderitem.delivered_at);
