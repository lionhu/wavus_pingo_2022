...
export default {
  ...
  props: { variations: Array, product_id: Number },
  data () {
    return {
  ...
  methods: {
    InventoryOpt (variation, opt) {
      const vm = this
      const _tilte = opt === 'plus' ? '在庫追加' : '在庫削除'
      const data = {
...
<template>
  <div>
              ...
              <tbody>
                <tr v-for="variation in variations" :key="variation.id">
                  <td class="text-center">
                    ...
                    <b-badge
                      v-if="variation.variation_type === 'REGULAR'"
                      variant="primary"
                      pill
                    >
                  ...
                  <td class="text-center">
                    ...
                    <a
                      ...
                      @click="InventoryOpt(variation, 'plus')"
                    >+</a>
                    <a
                      href="javascript:void(0);"
                      class="btn btn-danger d-block"
                      @click="InventoryOpt(variation, 'minus')"
                    >-</a>
                  </td>
                  <td class="text-right">
                    <span class="d-block">{{
                  ...
                  <td class="text-right">
                    <h5>
                      ...
                      >紹介ポイント</span>
                      <b-badge
                        v-if="variation.point_rule.is_valid"
    ...
    <VariationModal
      :show-variation-modal="showVariationModal"
      :mode-add="modeAdd"
      :edit_variation="edit_variation"
      :product_id="product_id"
      @operateresult="VariationOperate"
    />
  </div>
</template>
