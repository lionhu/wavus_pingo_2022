  ...
  methods: {
    updateProductInformation() {
      ...
      var product_edititems = {
        ...
        supplier_id: this.product.supplier_id?this.product.supplier_id:this.product.supplier.id,
  ...
  <b-modal id="modal-quick-editproduct" scrollable title="Edit Product Information" title-class="font-18"
    ...
    <form @submit.prevent="updateProductInformation">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            <label class="control-label">supplier - ({{product.supplier.name}})<span class="text-danger">*</span></label>
            <el-select v-model="product.supplier_id" placeholder="请选择">
              <el-option
