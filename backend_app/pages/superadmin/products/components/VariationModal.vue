...
export default {
  ...
  computed: {
    introduction_point_total () {
      ...
      return (
        parseInt(this.edit_variation.point_rule.policies.client_superadmin) +
        parseInt(this.edit_variation.point_rule.policies.client_admin) +
        parseInt(this.edit_variation.point_rule.policies.level_2) +
        parseInt(this.edit_variation.point_rule.policies.level_1) +
    ...
    profit () {
      const special_promotion_bonus = this.edit_variation.point_rule
        ...
        : 0
      return (
        parseInt(this.edit_variation.price) -
        parseInt(this.edit_variation.purchase_price) -
        parseInt(this.edit_variation.extra_cost) -
        this.introduction_point_total -
  ...
  methods: {
    updateProductVariationInformation () {
      ...
      this.edit_variation.purchase_price = parseInt(
        this.edit_variation.purchase_price
      )
      ...
      this.edit_variation.point_rule.policies.client_admin = parseInt(
        this.edit_variation.point_rule.policies.client_admin
      )
      this.edit_variation.point_rule.policies.client_superadmin = parseInt(
        this.edit_variation.point_rule.policies.client_superadmin
      )
      this.edit_variation.point_rule.policies.level_1 = parseInt(
        this.edit_variation.point_rule.policies.level_1
      )
      this.edit_variation.point_rule.policies.level_2 = parseInt(
        this.edit_variation.point_rule.policies.level_2
      )
      this.edit_variation.point_rule.policies.user_self = parseInt(
      ...
      if (!this.modeAdd) {
        ...
        this.$store
          .dispatch('products/create_variation', this.edit_variation)
          .then((response) => {
        ...
        <div class="col-md-12">
          <div class="form-group">
            ...
            <textarea
              ...
              :class="{
                'is-invalid': submitted && $v.edit_variation.description.$error,
              }"
            />

            <div
              v-if="submitted && !$v.edit_variation.description.required"
              class="invalid-feedback"
            >
              This value is required.
            </div>
