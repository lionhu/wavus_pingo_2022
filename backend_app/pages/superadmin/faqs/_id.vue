    ...
    if (parseInt(params.id) > 0) {
      ...
      let productDetail = await axios.get(url).then((response) => {
        if (response.data.result) {
          return productDetail = response.data.data
        } else {
          window.location.href = "/superadmin/ecommerce/products"
        }
      })
            ...
            <div class="row">
              <div class="col-lg-12">
                <el-upload
                  ...
                  :action="'/back/store/api/products/'+id+'/update_postimage/'"
                  ...
                  <tr v-for="variation in variations_admin">
                    ...
                    <td>
                      ...
                      <ul>
                        <li>
                          <span
                            class="inline-block text-right mr-3">Client Admin:</span>{{ variation.point_rule.policies.client_admin|currency("¥") }}
                        </li>
                        <li>
                          <span
                            class="inline-block text-right mr-3">Level 2:</span>{{ variation.point_rule.policies.level_2|currency("¥") }}
                        </li>
                        <li>
                          <span
                            class="inline-block text-right mr-3">Level 1:</span>{{ variation.point_rule.policies.level_1|currency("¥") }}
                        </li>
                      </ul>
                    </td>
    ...
    <b-modal id="modal_variation" scrollable title="Edit Variation Information" title-class="font-18"
      ...
      <form @submit.prevent="updateProductVariationInformation">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              <label for="field-client_admin" class="control-label">ClientAdmin
                <span class="text-danger">*</span>
              </label>
          ...
          <div class="col-md-4">
            <div class="form-group">
              <label for="field-level_2" class="control-label">Level 2
                <span class="text-danger">*</span>
              </label>
          ...
          <div class="col-md-4">
            <div class="form-group">
              <label for="field-level_1" class="control-label">Level 1
                <span class="text-danger">*</span>
              </label>
