...
<template>
  <b-modal id="modal-edit-supplier"
           scrollable title="New supplier Information"
           title-class="font-18"
           body-class="p-4"
           hide-footer
           v-if="showModal"
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" v-model="supplier.postcode" id="field-postcode" class="form-control"
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="text" id="field-state" v-model="supplier.state" class="form-control"
                   placehold="都道府県"/>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" id="field-city" v-model="supplier.city" class="form-control"
                   placeholder="東京都"/>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" id="field-town"
                   v-model="supplier.town" class="form-control" placeholder=""/>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <input type="text" id="field-address1" v-model="supplier.address_1" class="form-control"
                   placeholder="Address_1"/>
            <input type="text" id="field-address2" v-model="supplier.address_2" class="form-control"
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <input type="text" id="field-phone" v-model="supplier.phone" class="form-control"
                   placeholder="電話"/>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <input type="text" id="field-email" v-model="supplier.email" class="form-control"
                   placeholder="メール"/>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <input type="text" id="field-website" v-model="supplier.website" class="form-control"
                   placeholder="website"/>
          </div>
        </div>
      </div>
