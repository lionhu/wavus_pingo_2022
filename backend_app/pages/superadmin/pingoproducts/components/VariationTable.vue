...
export default {
  ...
  methods: {
    ...
    handleVariationImageSuccess(res, file) {
      console.log("handleVariationImageSuccess",res.variation.variation)
      if (res.result) {
